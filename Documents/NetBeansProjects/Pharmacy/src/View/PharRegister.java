 ...
 * @author 2ndyrGroupB
 */
public class PharRegister extends JFrame {
    ...
    private void pharmacistButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registerButtonMouseClicked
        ...
        if (isValid == 0) {
                ...
                db.PharmacistInfo(name, age, username, password);
